...
| File | Description |
|---|---|
| `Fishery_Population_Dynamics_Modelling_Report.pdf` | Written mathematical modelling report discussing logistic growth, harvesting equilibrium, overfishing risk, sustainability, and profitability |
